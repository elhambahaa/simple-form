This project consists of three main pages: the Welcome Page, the Register Page, and the Login Page. The purpose of this project is to demonstrate how to create a simple validation page using JavaScript.
